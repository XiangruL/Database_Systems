...
public class join {
	...
	public static StringBuilder joinRow(HashMap<String, HashMap<String, String>> newSchema,
			HashMap<String, HashMap<String, String>> oldSchema, String tableName,
			StringBuilder row1, StringBuilder row2, String query, boolean flag, boolean updateFlag){
		...
		if(row1.length()>0&&row2.length()>0){
			...
			if(updateFlag){
				...
				colNum1 = tool.getColNum(newSchema, tableName1, colName1);
				colNum2 = tool.getColNum(oldSchema, tableName2, colName2);
				processPlainSelect.pos1 = colNum1;
				processPlainSelect.pos2 = colNum2;
				if(flag){
					//create schema
					createSchema(oldSchema,newSchema, tableName1, tableName2, colName1, colName2);
				}else{
					
					createSchema1(newSchema,oldSchema, tableName1, tableName2, colName1, colName2);
				}
...
//				System.out.println(colName1+ " "+ colNum1);
//				System.out.println(colName2+ " "+ colNum2);
//				System.out.println(colName3+ " "+ colNum3);
//				System.out.println(colName4+ " "+ colNum4);
	...
	//update two table schema (only one column is the same)
	public static void createSchema(HashMap<String, HashMap<String, String>> oldSchema,
		...
		newSchema = schema;
//		newSchema = new HashMap<>(tool.createTable());
